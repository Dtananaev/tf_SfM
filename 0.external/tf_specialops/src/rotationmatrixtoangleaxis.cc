...
out:= A vector with 3 elements. The rotation angle is encoded in the lenght.
)doc");
...
REGISTER_KERNEL_BUILDER(                                                      \
    ...
    RotationMatrixToAngleAxisOp<false,type>);                                  
REG_KB(float)
REG_KB(double)
#undef REG_KB
...
REGISTER_KERNEL_BUILDER(                                                      \
    ...
    .Device(DEVICE_GPU)                                                       \
    .TypeConstraint<type>("T"),                                               \
    RotationMatrixToAngleAxisOp<true,type>);                                   
//REG_KB(float)
//REG_KB(double)
#undef REG_KB
...
REGISTER_KERNEL_BUILDER(                                                      \
    ...
    .Device(DEVICE_CPU)                                                       \
    .TypeConstraint<type>("T"),                                               \
    RotationMatrixToAngleAxisGradOp<false,type>);                              
REG_KB(float)
REG_KB(double)
#undef REG_KB
...
REGISTER_KERNEL_BUILDER(                                                      \
    ...
    .Device(DEVICE_GPU)                                                       \
    .TypeConstraint<type>("T"),                                               \
    RotationMatrixToAngleAxisGradOp<true,type>);                              
//REG_KB(float)
//REG_KB(double)
#undef REG_KB
