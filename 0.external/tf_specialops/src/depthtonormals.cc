...
REGISTER_OP("DepthToNormals")
  ...
  .Doc(R"doc(
This op computes the normal map from a depth map.
...
output:= Normal map in the coordinate system of the camera
